...
class RainTPL{
		...
		static $black_list = array('curl_exec','mysql_query', 'session_unset','ftp_exec','\$this', 'raintpl::', 'self::', '_SESSION', '_SERVER', '_ENV', '_GET', '_POST', 'eval', 'exec', 'unlink', 'rmdir');
    ...
    file_put_contents( $compiled_filename, preg_replace('/^\\s+|\\s+$/m', '', $template_compiled));
	}
